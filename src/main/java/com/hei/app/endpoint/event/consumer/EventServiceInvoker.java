package com.hei.app.endpoint.event.consumer;

import com.hei.app.PojaGenerated;
import com.hei.app.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.hei.app.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.hei.app.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
